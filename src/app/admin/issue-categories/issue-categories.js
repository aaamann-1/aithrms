...
let IssueCategoriesComponent = class IssueCategoriesComponent {
    router;
    currentUser;
    searchText = '';
    ...
    get filteredCategories() {
        ...
        return this.categories.filter(category => `${category.name} ${category.description}`
            .toLowerCase()
            .includes(search));
    }
    get userInitials() {
...
IssueCategoriesComponent = __decorate([
    Component({
...
export { IssueCategoriesComponent };
