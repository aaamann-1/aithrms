...
let TeamReportsComponent = class TeamReportsComponent {
    router;
    /* =========================================
       SIDEBAR
    ========================================= */
    ...
    get filteredStaff() {
        ...
        return this.staffReports.filter(staff => staff.name.toLowerCase().includes(search) ||
    ...
    /* =========================================
       RESOLUTION RATE
    ========================================= */
    getResolutionRate(staff) {
        if (staff.totalTickets === 0) {
            return 0;
        }
        return Math.round((staff.resolved / staff.totalTickets) * 100);
    }
    /* =========================================
       CHART HEIGHT
    ========================================= */
    getBarHeight(value) {
        const maxTickets = 50;
        return Math.min(Math.round((value / maxTickets) * 100), 100);
    }
    /* =========================================
       TOTAL TICKETS
    ========================================= */
    get totalTickets() {
        return this.filteredStaff.reduce((total, staff) => total + staff.totalTickets, 0);
    }
    /* =========================================
       TOTAL RESOLVED
    ========================================= */
    get totalResolved() {
        return this.filteredStaff.reduce((total, staff) => total + staff.resolved, 0);
    }
    /* =========================================
       TOTAL PENDING
    ========================================= */
    get totalPending() {
        return this.filteredStaff.reduce((total, staff) => total + staff.pending, 0);
    }
    /* =========================================
       TOTAL ESCALATED
    ========================================= */
    get totalEscalated() {
        return this.filteredStaff.reduce((total, staff) => total + staff.escalated, 0);
    }
    /* =========================================
       TEAM RESOLUTION RATE
    ========================================= */
    get teamResolutionRate() {
        if (this.totalTickets === 0) {
            return 0;
        }
        return Math.round((this.totalResolved / this.totalTickets) * 100);
    }
};
TeamReportsComponent = __decorate([
    Component({
